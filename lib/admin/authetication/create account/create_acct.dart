...
class AdminCreateAcct extends StatefulWidget {
  final VoidCallback showLogin;
  const AdminCreateAcct({super.key, required this.showLogin});

  @override
  State<AdminCreateAcct> createState() => _AdminCreateAcctState();
}

class _AdminCreateAcctState extends State<AdminCreateAcct> {
      ...
      if (e.code == "email-already-in-use") {
        ...
        showDialog(
            ...
            builder: (context) {
              return AlertDialog(
                content: Text(
                    'The email address is already exist try logging in with this email',
